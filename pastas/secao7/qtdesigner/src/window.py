...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.buttonName = QPushButton(self.centralwidget)
        self.buttonName.setObjectName(u"buttonName")
        font2 = QFont()
        font2.setPointSize(25)
        self.buttonName.setFont(font2)

        self.gridLayout_2.addWidget(self.buttonName, 0, 2, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.labelResult.setText(QCoreApplication.translate("MainWindow", u"Texto meramente ilustrativo", None))
        self.labelName.setText(QCoreApplication.translate("MainWindow", u"Seu Nome:", None))
        self.lineName.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Digite seu nome aqui", None))
        self.buttonName.setText(QCoreApplication.translate("MainWindow", u"Enviar", None))
    # retranslateUi
